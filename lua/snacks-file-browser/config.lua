...
local default_config = {
	...
	toggles = {
		show_hidden = { icon = "h", value = true },
		show_ignored = { icon = "i", value = true },
		follow_symlinks = { icon = "f", value = true },
	},
	supports_live = true,
	...
	win = {
		input = {
			keys = {
				...
				["<M-i>"] = { "toggle_show_ignored", mode = { "n", "i" } },
				["<M-h>"] = { "toggle_show_hidden", mode = { "n", "i" } },
				["<M-l>"] = { "toggle_follow_symlinks", mode = { "n", "i" } },
				["<F5>"] = { "refresh", mode = { "n", "i" } },
			},
		},
		list = {
